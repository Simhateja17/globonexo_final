...
const locations = [
  // USA – Boston (yellow dot on left side)
  {
    id: 'usa',
    name: 'USA – Boston',
    designations: [{ type: 'Sales & Representation offices', color: '#FAAD14' }],
    x: 4.8,
    y: 44,
  },
  ...
  // Germany – Stuttgart (red dot - both HQ and Sales)
  {
    ...
    designations: [
      { type: 'Sales & Representation offices', color: '#FAAD14' },
  ...
  // Lithuania – Vilnius (green dot)
  {
    ...
    designations: [{ type: 'Development centers', color: '#95DE64' }],
    x: 52.5,
    y: 26,
  },
